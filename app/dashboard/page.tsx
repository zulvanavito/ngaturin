  ...
  const chartData = useMemo(() => {
    ...
    for (let i = 6; i >= 0; i--) {
      ...
      days.push({
        ...
        Income: dayIncome,
        Expense: dayExpense,
        Savings: Math.max(0, dayIncome - dayExpense),
      });
    }
    return days;
  }, [transactions]);
      ...
      <header className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-2">
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto justify-end">
          <Button
            variant="ghost"
            size="icon"
            className="rounded-full bg-white dark:bg-card border border-border/40"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="flex items-center gap-6 mt-4">
                {["Savings", "Income", "Expense"].map((key, i) => (
                  <div key={key} className="flex items-center gap-2">
                    <div
                      className={`w-2 h-2 rounded-full ${i === 0 ? "bg-[#9fe870]" : i === 1 ? "bg-[#e2f6d5]" : "bg-[#0e0f0c]"}`}
                    />
            ...
            <div className="space-y-4">
              {[
                ...
                <div
                  key={i}
                  className="bg-white dark:bg-card rounded-3xl border border-border/40 p-5 shadow-sm flex flex-col justify-between h-[100px]"
                >
                  ...
                  <div className="flex items-end justify-between">
                    ...
                    {i < 2 && (
                      <span
                        className={`text-[10px] font-bold ${stat.color} ${stat.bg} px-2 py-0.5 rounded-full`}
                      >
                        +5.1%
                      </span>
                    )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-[#0e0f0c] text-white rounded-[2rem] p-6 relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <h3 className="font-bold text-sm mb-1 text-[#9fe870]">
                  Optimize your budget
                </h3>
                <p className="text-[10px] text-white/50 mb-4 max-w-[200px]">
                  Start preparing for the 2025 tax season by saving 10-15% for
                  deductions.
                </p>
                <Link
                  href="/dashboard/insights"
                  className="text-[10px] font-bold flex items-center gap-1 hover:text-[#9fe870] transition-colors"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white dark:bg-card rounded-[2rem] border border-border/40 p-5 flex flex-col items-center">
              <h3 className="font-bold text-sm self-start mb-6">
                Financial health
              </h3>
              ...
              <p className="text-[10px] text-center text-muted-foreground mt-2">
                Based on your savings ratio over the past 30 days.
              </p>
            </div>
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="bg-white dark:bg-card rounded-[2rem] border border-border/40 p-6 shadow-sm">
            ...
            <DashboardRecentTx transactions={transactions} onEdit={handleEdit} />
            <Link
              href="/dashboard/transactions"
