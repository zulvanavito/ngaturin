...
const featuresData = [
  {
    ...
    description:
      "Pengingat otomatis untuk subscription dan cicilan agar tak pernah telat.",
  },
  {
    icon: LayoutDashboard,
    title: "Dashboard & Analitik",
    description:
      "Ringkasan saldo, tren pengeluaran, dan wawasan keuangan yang interaktif.",
  },
  {
    icon: Shield,
    title: "Keamanan Terjamin",
    description:
      "Data keuangan tersimpan secara aman dengan kontrol akses akun privat.",
  },
  {
    icon: RefreshCw,
    title: "Sinkronisasi Cloud",
    description:
      "Akses data keuangan Anda secara real-time dari berbagai perangkat modern.",
  },
];
...
const faqs = [
  {
    ...
    answer:
      "Ngaturin adalah platform terpadu untuk mengelola kehidupan finansial dan produktivitas Anda. Kami menggunakan kerangka kerja PARA (Projects, Areas, Resources, Archives) yang disatukan dengan kemampuan pencatatan keuangan dan Habit Tracker.",
  },
  {
    question: "Apakah Ngaturin benar-benar gratis?",
    answer:
      "Ya! Kami menyediakan platform manajemen holistik ini 100% tanpa biaya langganan apapun, dengan akses fitur yang bebas Anda eksplorasi.",
  },
  {
    question: "Apakah data keuangan saya aman di sini?",
    answer:
      "Tentu. Keamanan privasi Anda adalah prioritas kami. Data Anda dikelola menggunakan standar kontrol akses yang ketat agar privasi terjamin.",
  },
  {
    question: "Bisakah diakses di banyak perangkat?",
    answer:
      "Tentu saja. Sistem kami berbasis Cloud sehingga seluruh aset, utang-piutang, dan progres Anda dapat dipantau dari smartphone maupun laptop secara real-time.",
  },
  {
    question: "Bagaimana integrasi dengan Habit Tracker bekerja?",
    answer:
      "Habit tracker membantu Anda melacak kebiasaan baik harian, seperti mencatat pengeluaran. Dengan mengakumulasi rekor beruntun, Anda akan lebih termotivasi mengontrol hidup.",
  },
];
      ...
      <div className="max-w-4xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-lg font-medium">
            Temukan jawaban atas berbagai fungsi dan penggunaan Ngaturin
            sehari-hari.
          </p>
        </div>
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen flex flex-col bg-background font-sans">
      ...
      <section className="relative overflow-hidden pt-24 pb-20 md:pt-32 md:pb-32">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed font-medium">
            Lebih dari sekadar memantau saldo. Lacak kebiasaan, rapikan hidup
            dengan metode PARA, dan kendalikan total aset Anda melalui satu{" "}
            <i>platform</i> cerdas nan gratis.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-10">
            <h3 className="text-2xl font-bold text-foreground">
              Statistik Pengguna Ngaturin: Membangun Kebiasaan Positif.
            </h3>
            <p className="text-muted-foreground mt-2 font-medium">
              Lacak kebiasaan holistik, raih target hidup, dan nikmati manajemen
              otomatis.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6 flex flex-col gap-32">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed font-medium">
                Kendalikan arus keuangan sekaligus informasi Anda menggunakan
                kerangka{" "}
                <strong>PARA (Projects, Areas, Resources, Archives)</strong>.
                Padukan pengorganisasian rapi ini dengan{" "}
                <strong>Habit Tracker</strong> bawaan untuk melacak kebiasaan
                harian (seperti mencatat transaksi atau menabung) dan ciptakan
                kualitas hidup yang terus membaik setiap hari.
              </p>
              <Button
                asChild
                variant="outline"
                className="rounded-2xl h-14 px-8 font-bold border-border/40 hover:bg-muted/50"
              >
                <Link href="/auth/sign-up">
          ...
          <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed font-medium">
                Tingkatkan rutinitas harian dengan pemantauan ringkas atas
                seluruh dana Anda. Dari Kas, Piutang, hingga Investasi, semua
                terlihat jelas untuk optimasi yang efektif.
              </p>
              <Button
                asChild
                className="bg-primary text-primary-foreground rounded-2xl h-14 px-8 font-bold hover:brightness-110"
              >
                <Link href="/auth/sign-up">
              ...
              <div className="p-8 rounded-[2.5rem] bg-card border border-border/20 shadow-2xl glass w-full max-w-md">
                ...
                <div className="flex justify-between mt-3 text-xs font-bold text-muted-foreground">
                  <span className="flex items-center gap-1">
                    <div className="w-2 h-2 rounded-full bg-primary" /> Kas
                  </span>
                  <span className="flex items-center gap-1">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-8">
            ...
            <div className="flex-1 flex flex-col gap-8 w-full order-2 lg:order-1 lg:items-end text-center lg:text-right">
              <div className="flex flex-col lg:items-end gap-3 max-w-sm">
                ...
                <h4 className="text-xl font-extrabold text-foreground">
                  Analisis Bisnis & Tren
                </h4>
                <p className="text-muted-foreground text-sm font-medium">
                  Buka berbagai potensi dan temukan peluang pertumbuhan dengan
                  wawasan mendalam atas arus kas Anda.
                </p>
              </div>
              <div className="flex flex-col lg:items-end gap-3 max-w-sm">
                ...
                <p className="text-muted-foreground text-sm font-medium">
                  Batasi pengeluaran berlebih dan capai kepastian finansial,
                  mengatur dana menjadi sangat presisi dan memuaskan.
                </p>
              </div>
            </div>
            ...
            <div className="flex-1 flex flex-col gap-8 w-full order-3 text-center lg:text-left">
              <div className="flex flex-col lg:items-start gap-3 max-w-sm">
                ...
                <p className="text-muted-foreground text-sm font-medium">
                  Berikan ruang untuk memastikan siapa yang berutang, memudahkan
                  monitor pelunasan pada satu tampilan rapi.
                </p>
              </div>
              <div className="flex flex-col lg:items-start gap-3 max-w-sm">
                ...
                <h4 className="text-xl font-extrabold text-foreground">
                  Manajemen Saldo Multi-Dompet
                </h4>
                <p className="text-muted-foreground text-sm font-medium">
                  Pisahkan uang makan, tabungan pribadi, hingga dana darurat ke
                  masing-masing kantong (dompet) yang berbeda.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto text-body-md md:text-body-semibold">
              Eksplorasi panel pintar kami untuk pencatatan lebih cepat dan
      ...
      <section
        id="harga"
        className="py-24 bg-muted/5 border-t border-border/10"
      >
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto text-body-md md:text-body-semibold">
              Pilih paket yang sesuai dengan kebutuhanmu. Lebih murah dari
              segelas kopi, untuk keuangan yang lebih rapi selamanya.
            </p>
          </div>
          ...
          <div className="relative overflow-hidden rounded-[3rem] bg-primary p-12 md:p-20 shadow-ring flex flex-col md:flex-row items-center justify-between gap-12">
            ...
            <div className="relative z-10 flex-1 max-w-lg text-center md:text-left">
              <h2 className="text-heading-sub md:text-heading-section font-black text-primary-foreground mb-6">
                Dapatkan Ngaturin.
                <br />
                Tata Ulang Hidup Anda Sekarang.
              </h2>
              <p className="text-primary-foreground/90 md:text-body-semibold mb-10">
                Sederhanakan rutinitas harian dan raih kebebasan waktu serta
                finansial bersama Ngaturin. Manfaatkan sistem yang
                memberdayakan.
              </p>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-start gap-12 mb-12">
            ...
            <div className="flex gap-16 md:gap-24">
              <div className="flex flex-col gap-4">
                <h5 className="font-extrabold text-foreground mb-2">
                  Platform
                </h5>
                <Link
                  href="/auth/login"
