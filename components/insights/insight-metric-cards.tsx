...
export function InsightMetricCards({
  summary,
  globalSummary,
      ...
      {metrics.map((m, i) => (
        ...
        >
          <div className="flex items-start justify-between mb-4">
            <div
              className={`w-12 h-12 rounded-2xl ${m.color} flex items-center justify-center shadow-lg transform group-hover:rotate-12 transition-transform`}
            >
